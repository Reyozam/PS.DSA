#
# Manifeste de module pour le module « PS-DSA »
#
# Généré par : Julien Mazoyer
#
# Généré le : 21/11/2019
#
...
ModuleVersion = '2022.12.01'

# Éditions PS prises en charge
# CompatiblePSEditions = @()

# ID utilisé pour identifier de manière unique ce module
GUID = '8228f4be-0813-4ead-bcd1-f0438df1c70e'
...
Copyright = '(c) 2019 Julien Mazoyer. Tous droits réservés.'

# Description de la fonctionnalité fournie par ce module
Description = 'Cli GUI for basic AD Object actions'
...
ScriptsToProcess = @(".\Classes\PSAUser.Class.ps1")
